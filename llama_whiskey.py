...
whiskey_notes_table = """
┌------------------------|--------------|---------------------------------------------------------------------------┐
| Flavor Characteristics | Description  |                                   type                                    |
| ---------------------- + ------------ | ------------------------------------------------------------------------- |
|                        | Medicinal    | Iodine, Seaweed, Carbolic, Tar, Diesel Oil                                |
|         Peaty          | Smokey       | Incense, Bonfire, Lapsang Souchong, Peat Reek                             |
|                        | Kippery      | Smoked Salmon, Smoked Oysters, Sea-Shells, Dried Shellfish                |
|                        | Mossy        | Moss Water, Birchy, Earthy, Turf, Fishing Nets                            |
| ---------------------- + ------------ | ------------------------------------------------------------------------- |
|                        | Citrus       | Lemon, Kiwi, Orange, Zest                                                 |
|                        | Fresh Fruit  | Apples, Pears, Peaches, Fruit Salad                                       |
|         Fruity         | Cooked Fruit | Stewed Apples, Marmalade, Jam, Candied Fruits                             |
|                        | Dried Fruit  | Raisins, Figs, Apricots, Prunes, Mixed Peel, Fruit Cake, Mince Pies       |
|                        | Solvent      | Nail Varnish Remover, Bubble Gum, Acid Drops, Turps, Paint                |
| ---------------------- + ------------ + ------------------------------------------------------------------------- |
|                        | Green-House  | Geraniums, Green Tomatoes, Parmviolets, Florists' shop                    |
|         Floral         | Fragrant     | Perfumed, Fabric Softner, Carnation, Coconut, Lavender                    |
|                        | Leafy        | Green Leaves, Lawn Clippings, Green Sticks, Pea Pods, Pine Nuts           |
|                        | Hay-Like     | Mown Hay, Dry Hay, Barns, Heather Flowers, Herbal                         |
| ---------------------- + ------------ + ------------------------------------------------------------------------- |
|                        | New Wood     | Resinous, Cigar Boxes, Sandalwood, Ginger, Pepper, Allspice, Nutmeg       |
|         Woody          | Old Wood     | Musty, Bung Cloth, Cardboard, Cellars, Pencils, Cork                      |
|                        | Vanilla      | Custard, Meringues, Madeira Cake, Toffee                                  |
|                        | Toasted      | Rice Pudding, Burnt Toast, Coffee Grounds, Fennel, Aniseed                |
| ---------------------- + ------------ + ------------------------------------------------------------------------- |
|                        | Sherried     | Chardonnay, Fino, Oloroso, Armagnac, Madeira, Port                        |
|         Winey          | Nutty        | Walnuts, Hazel Nuts, Praline, Almonds, Marzipan                           |
|                        | Chocolate    | Cream, Butter, Milk Chocolate, Cocoa, Bitter Chocolate                    |
|                        | Oily         | Linseed Oil, Candle Wax, Suntan Oil, Almond Oil                           |
| ---------------------- + ------------ + ------------------------------------------------------------------------- |
|                        | Cooked Mash  | Porridge, Draft, Cooked Maize, Hen's Mash                                 |
|                        | Cooked Veg   | Mashed Potato, Potato Scones, Sweetcorn, Cooked Swedge                    |
|         Cereal         | Malt Extract | Malted Milk, Marmite, Bran, Cake                                          |
|                        | Husky        | Dried Hops, Mousey, Pot, Ale, Iron Tonic                                  |
|                        | Yeasty       | Boiled Pork, Pork Sausages, Meaty, Gravy                                  |
| ---------------------- + ------------ + ------------------------------------------------------------------------- |
|                        | Plastic      | Plastic Mac, Plastic Bucket, Plastic Rope, Oilskin                        |
|                        | Sweaty       | Buttermilk, Cheese, Yeast, Old Gym Shoes, Shoe Polish                     |
|         Feinty         | Tobacco      | Dried Tea, Tea Pots, Fresh Tobacco, Green Tobacco, Tobacco-Ash            |
|                        | Leathery     | Libraries, New Cowhide, Mealy, Digestive Biscuits                         |
|                        | Honey        | Clover Honey, Heather Honey, Mead, Beeswax, Polish                        |
| ---------------------- + ------------ + ------------------------------------------------------------------------- |
|                        | Vegitative   | Brackish, Cabbage Water, Turnips, Stagnant, Marsh Gas                     |
|        Sulphury        | Coal Gas     | Carbide, Cordite, Spent Fireworks, Spent Matches, Matchbox                |
|                        | Rubbery      | Pencil Eraser, New Rubber (tyres), Bakelite, Electric Cable, Burnt Rubber |
|                        | Sandy        | Fresh Laundry, Starch, Linen, Sandy Beach, Hot Sand, Elemental Sulphur    |
└----------------------- | ------------ | --------------------------------------------------------------------------┘
"""
...
def generate_llm_response():
    ...
    if arguments.ko:
        ...
        dialogue_preset = "<s>[INST]<<SYS>>\n" \
                          "You are a top-class bartender who can recommend a whiskey that can fit the customer's preferences.\n" \
                          "You should recommend a specific one to your customer among your varius whiskey collection.\n" \
    ...
    while True:
        ...
        if question == "Good bye Bartender!":
            print("-----Bot-----")
            print("Bot: Good bye Buddy!")
            break
        regen = True
        if arguments.ko:
            while True:
