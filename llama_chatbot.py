...
whiskey_notes = {
  "Peaty": {
    "Medicinal": ["Iodine", "Seaweed", "Rubber"],
    "Smoky": ["Smoke", "Bonfire", "Charred Wood"],
    "Peated": ["Peat Reek", "Phenolic", "Tarry Rope"],
    "Feinty": ["Meaty", "Leathery", "Dunnage Warehouse"]
  },
  "Fruity": {
    "Citrus": ["Lemon", "Lime", "Orange"],
    "Soft": ["Peach", "Apricot", "Melon"],
    "Dried": ["Raisin", "Prune", "Date"],
    "Tropical": ["Banana", "Pineapple", "Lychee"]
  },
  "Floral": {
    "Fresh": ["Grassy", "Alpine", "Floral"],
    "Fragrant": ["Perfumed", "Rose", "Geranium"],
    "Dried": ["Tobacco", "Hay", "Potpourri"]
  },
  "Woody": {
    "Oaky": ["Vanilla", "Coconut", "Clove"],
    "Resinous": ["Pine", "Cedar", "Eucalyptus"],
    "Mature": ["Leather", "Tobacco Leaf", "Oak"]
  },
  "Winey": {
    "Sherry": ["Raisin", "Nutty", "Fruity"],
    "Cask": ["Port", "Madeira", "Marsala"],
    "Fermented": ["Yeast", "Sour", "Balsamic"]
  },
  "Nutty": {
    "Kernel": ["Almond", "Hazelnut", "Walnut"],
    "Husky": ["Bran", "Lees", "Malt"],
    "Woody": ["Chestnut", "Cedar", "Cigar Box"]
  },
  "Spicy": {
    "Hot": ["Pepper", "Chilli", "Ginger"],
    "Warm": ["Cinnamon", "Nutmeg", "Allspice"],
    "Sweet": ["Liquorice", "Honey", "Vanilla"]
  },
  "Sweet": {
    "Candy": ["Marshmallow", "Fudge", "Butterscotch"],
    "Fruity": ["Jammy", "Marmalade", "Fruitcake"],
    "Malty": ["Shortbread", "Cereal", "Pastry"]
  },
  "Cereal": {
    "Grain": ["Barley", "Wheat", "Oatmeal"],
    "Malted": ["Malt", "Biscuit", "Grist"],
    "Toasted": ["Toast", "Roasted", "Nutty"]
  },
  "Feinty": {
    "Sulphury": ["Sulphur", "Rubber", "Struck Match"],
    "Musty": ["Dusty", "Mouldy", "Mildew"],
    "Catty": ["Blackcurrant", "Mint", "Tomato Leaf"]
  },
  "Sulphury": {
    "Match": ["Struck Match", "Firework", "Gunpowder"],
    "Cooked": ["Boiled Cabbage", "Burnt Rubber", "Drains"],
    "Cereal": ["Husk", "Meal", "Porridge"]
  },
  "Fresh": {
    "Grassy": ["Cut Grass", "Hedge Clipping", "Greenhouse"],
    "Minty": ["Mint", "Eucalyptus", "Tea Tree"],
    "Estery": ["Pear Drops", "Pineapple Cube", "Banana Skins"]
  }
}
